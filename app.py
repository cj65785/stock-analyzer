...
<style>
    ...
    .stTabs [data-baseweb="tab"] {
        height: 36px; font-size: 15px; padding: 0 18px;
    ...
    .stExpander > details > summary {
        padding: 9px 4px !important; font-size: 15px !important;
    ...
    /* ── 입력 ── */
    .stTextArea textarea, .stTextInput input { font-size: 15px; }
...
<div style="font-size:15px;line-height:1.7;color:#222;padding:4px 0 10px 0;">{dart}</div>
...
<div style="font-size:15px;line-height:1.7;color:#222;padding:4px 0 2px 0;">{news}</div>
{nav_html}
</div>"""
