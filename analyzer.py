...
class DartProcessor:
    ...
    def find_listed_corp_code(self, company_name: str) -> Optional[str]:
        try:
    ...
    def process(self, company_name: str) -> Tuple[str, str, str]:
        code = self.find_listed_corp_code(company_name)
        if not code:
